   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "\n",
       "        AMT_CREDIT  ...  FLAG_MOBIL  FLAG_EMP_PHONE FLAG_WORK_PHONE  \\\n",
       "307506    254700.0  ...           1               1               0   \n",
       "307507    269550.0  ...           1               0               0   \n",
       "307508    677664.0  ...           1               1               0   \n",
       "307509    370107.0  ...           1               1               0   \n",
       "307510    675000.0  ...           1               1               1   \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "          Unnamed: 0     SK_ID_CURR         TARGET   CNT_CHILDREN  \\\n",
       "count  307511.000000  307511.000000  307511.000000  307511.000000   \n",
       "mean   153755.000000  278180.518577       0.080729       0.417052   \n",
       "std     88770.923652  102790.175348       0.272419       0.722121   \n",
       "min         0.000000  100002.000000       0.000000       0.000000   \n",
       "25%     76877.500000  189145.500000       0.000000       0.000000   \n",
       "50%    153755.000000  278202.000000       0.000000       0.000000   \n",
       "75%    230632.500000  367142.500000       0.000000       1.000000   \n",
       "max    307510.000000  456255.000000       1.000000      19.000000   \n",
       "\n",
       ...
       "\n",
       "       REGION_POPULATION_RELATIVE     DAYS_BIRTH  ...    OWN_CAR_AGE  \\\n",
       "count               307511.000000  307511.000000  ...  104582.000000   \n",
       "mean                     0.020868  -16036.995067  ...      12.061091   \n",
       "std                      0.013831    4363.988632  ...      11.944812   \n",
       "min                      0.000290  -25229.000000  ...       0.000000   \n",
       "25%                      0.010006  -19682.000000  ...       5.000000   \n",
       "50%                      0.018850  -15750.000000  ...       9.000000   \n",
       "75%                      0.028663  -12413.000000  ...      15.000000   \n",
       "max                      0.072508   -7489.000000  ...      91.000000   \n",
       "\n",
